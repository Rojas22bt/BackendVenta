...
from .controllers.controller_bitacora import obtenerBitacora, BitacoraCreateAPIView
...
urlpatterns = [
    ...
    path('/crear-bitacora',BitacoraCreateAPIView.as_view(), name='bitacora-nueva' ),
